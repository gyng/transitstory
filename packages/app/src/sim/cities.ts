...
export interface CityEntry {
   ...
   *  a city's data changes. Last measured 2026-06-10. */
  realScore: number;
}
...
export const CITIES: CityEntry[] = [
  ...
  { id: "tokyo", name: "Tokyo", blurb: "JR + subway — the big one", manifest: "/data/tokyo_city.json", realScore: 38 },
  { id: "calgary", name: "Calgary", blurb: "C-Train — LRT + free-fare downtown", manifest: "/data/calgary_city.json", realScore: 13 },
  { id: "istanbul", name: "Istanbul", blurb: "Bosphorus — two continents, ferry country", manifest: "/data/istanbul_city.json", realScore: 46 },
  { id: "manhattan", name: "New York", blurb: "Manhattan — a dense linear island", manifest: "/data/manhattan_city.json", realScore: 23 },
  { id: "dublin", name: "Dublin", blurb: "Liffey city — a gentle starter", manifest: "/data/dublin_city.json", realScore: 39 },
  { id: "chicago", name: "Chicago", blurb: "The 'L' loop + lakefront grid", manifest: "/data/chicago_city.json", realScore: 31 },
  { id: "sf", name: "San Francisco", blurb: "Bay peninsula + transbay BART", manifest: "/data/sf_city.json", realScore: 47 },
  { id: "brisbane", name: "Brisbane", blurb: "Subtropical river city", manifest: "/data/brisbane_city.json", realScore: 29 },
  { id: "london", name: "London", blurb: "The Tube — radial across the Thames", manifest: "/data/london_city.json", realScore: 45 },
  { id: "pyongyang", name: "Pyongyang", blurb: "Deep metro on the Taedong", manifest: "/data/pyongyang_city.json", realScore: 38 },
  { id: "glasgow", name: "Glasgow", blurb: "Clockwork-Orange loop on the Clyde", manifest: "/data/glasgow_city.json", realScore: 39 },
  { id: "globe", name: "World ✈", blurb: "Global airline — connect cities by air", manifest: "/data/globe_city.json", realScore: 54 },
];
