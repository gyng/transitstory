...
/** Fetch the manifest + grid, set the session's coordinate origin, and assemble the core
 *  city JSON. setOrigin MUST happen before buildCoreCity so demand lng/lat -> mm is correct. */
